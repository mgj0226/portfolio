...
const About = ({aboutTitleRef, aboutSubTitle1Ref, aboutSubTitle2Ref}) => {
    return(
        <VStack spacing={4} className="about">
            ...
            <Heading ref={aboutTitleRef} size="xl" className="aboutTitle aboutTitleAni">Michael</Heading>
            <Heading ref={aboutSubTitle1Ref} size="xl" className="aboutSubTitle1 aboutSubTitleAni1">Front-End React</Heading>
            <Heading ref={aboutSubTitle2Ref} size="xl" className="aboutSubTitle2 aboutSubTitleAni2">Developer</Heading>
